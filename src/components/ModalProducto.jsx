...
export default function ModalProducto() {
    ...
    useEffect(() => {
        if(pedido.some(pedidoState => pedidoState.id === producto.id)) {
            const productoEditar = pedido.filter(pedidoState => pedidoState.id === 
                producto.id)[0]
    ...
    <div className="md:flex gap-8">
        ...
        <div className="md:w-2/3">
            ...
            <p className="mt-4 font-black text-4xl text-cyan-700">
            ...
            <button type="button"
                    className="bg-indigo-800 hover:bg-indigo-600 px-5 py-2 mt-5 text-white
